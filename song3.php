    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="mainNav">
            <div class="container px-4">
                <a class="navbar-brand" href="http://localhost/melomaniac-activity/index.php"> ChocoMingBeats</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link text-light" href="http://localhost/melomaniac-activity/song3.php">Song 3</a></li>
                         <li class="nav-item"><a class="nav-link text-light" href="http://localhost/melomaniac-activity/song4.php">Song 4</a></li>
                          <li class="nav-item"><a class="nav-link text-light" href="http://localhost/melomaniac-activity/song5.php">Song 5</a></li>
                    </ul>
                </div>
            </div>
        </nav>
